 ...
 */
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".icon-menu")) {
                    ...
                    if (document.documentElement.classList.contains("sub-catalog-open")) document.documentElement.classList.remove("sub-catalog-open");
                }
            }));
        }
        function menuClose() {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".novelty__slider")) new core(".novelty__slider", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                navigation: {
                    prevEl: ".novelty-button-prev",
                    nextEl: ".novelty-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 2,
            ...
            if (document.querySelector(".special-offers__slider")) new core(".special-offers__slider", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                navigation: {
                    prevEl: ".special-offers-button-prev",
                    nextEl: ".special-offers-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 2,
            ...
            if (document.querySelector(".popular-goods__slider")) new core(".popular-goods__slider", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            if (document.querySelector(".page-partners__slider")) new core(".page-partners__slider", {
            ...
            if (document.querySelector(".similar-product__slider")) new core(".similar-product__slider", {
                modules: [ Navigation, Autoplay, Scrollbar ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
        ...
        $(window).scroll((function() {
            if ($(this).scrollTop() > 300) $(".up-scroll").fadeIn(); else $(".up-scroll").fadeOut();
        }));
        ...
        var tekuscheyeVremya = new Date;
        var deadlineTime = tekuscheyeVremya.setMinutes(tekuscheyeVremya.getMinutes() + 2);
        var obratniyOtschet = setInterval((function() {
            var seychas = (new Date).getTime();
            var ostatokVremeni = deadlineTime - seychas;
            var minuti = Math.floor(ostatokVremeni % (1e3 * 60 * 60) / (1e3 * 60));
            var secundi = Math.floor(ostatokVremeni % (1e3 * 60) / 1e3);
            ...
            if (ostatokVremeni < 0) {
                ...
                document.getElementById("time-remainer").innerHTML = "<a href='#'>Отправить повторно</a>";
            }
        }), 1e3);
        let inputs = document.querySelectorAll(".upload-information__upload-none");
        Array.prototype.forEach.call(inputs, (function(input) {
            let label = input.nextElementSibling, labelVal = label.querySelector(".upload-information__upload-text").innerText;
            input.addEventListener("change", (function(e) {
                let countFiles = "";
                if (this.files && this.files.length >= 1) countFiles = this.files.length;
                if (countFiles) label.querySelector(".upload-information__upload-text").innerText = "Выбрано файлов: " + countFiles; else label.querySelector(".upload-information__upload-text").innerText = labelVal;
            }));
        }));
        let menuParents = document.querySelectorAll(".catalog-header__parent");
        ...
        function documentActions(e) {
            const targetElement = e.target;
            if (targetElement.closest(".catalog-header")) document.documentElement.classList.add("catalog-open");
            if (targetElement.closest(".catalog-header__back")) document.documentElement.classList.remove("catalog-open");
        ...
        (function() {
            ...
            function Ascroll() {
                if (null == b) {
                    ...
                    for (var i = 0; i < Sa.length; i++) if (0 == Sa[i].indexOf("box-sizing") || 0 == Sa[i].indexOf("overflow") || 0 == Sa[i].indexOf("width") || 0 == Sa[i].indexOf("padding") || 0 == Sa[i].indexOf("border") || 0 == Sa[i].indexOf("outline") || 0 == Sa[i].indexOf("box-shadow") || 0 == Sa[i].indexOf("background")) s += Sa[i] + ": " + Sa.getPropertyValue(Sa[i]) + "; ";
